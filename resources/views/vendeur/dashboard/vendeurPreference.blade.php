...
<head>
    ...
    <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
        ...
        <link rel="stylesheet" href="{{ asset('css/vendeur/vendeurPreference.css') }}"/>
</head>
...
<body>
         ...
         <div>
            <div class="container-xl px-4 mt-4">
                ...
                <nav class="nav nav-borders">
                    ...
                    <a class="nav-link active ms-0" href="{{ url('/vendeur/preference') }}" target="__blank" >Notifications</a>
                </nav>
                <hr class="mt-0 mb-4">
                <div class="row">
                ...
                <div class="card mb-4">
                <div class="card-header">Paramètres d'email</div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="small mb-1" >Paramètres d'email</label>
                         <label class="small mb-1"> Nous vous envoyons différents mails concernant les commandes reçues sur la plateforme Leftover. Vous pouvez sélectionner ceux que vous souhaitez recevoir et sur quelle adresse mail les recevoir.</label>
                        </label>   
                    </div>
                        <hr style="height:1px;border-width:0;color:gray;background-color:gray"> 
                         <!-- check boxes-->
                        <label class="toggle" for="unique">
                            <input type="checkbox" class="toggle__input" id="unique" />
                            <span class="toggle-track">
                                <span class="toggle-indicator">
                                    <!-- 	This check mark is optional	 -->
                                    <span class="checkMark">
                                        <svg viewBox="0 0 30 30" id="ghq-svg-check" role="presentation" aria-hidden="true">
                        ...
                        <div class="mb-3">
                             <label class="small mb-1">Mail envoyé pour chaque commande ayant été réservée.</label>
                            </label>
                        ...
                        <br>
                        <div class="mb-3">
                             <label class="small mb-1">Mail envoyé si une commande a été annulée avant la collecte.</label>
                            </label>
                        ...
                        <div class="mb-3">
                            <label class="small mb-1" >Ces mails sont envoyés à l'adresse suivante :</label>
                             <label class="small mb-1" style="background-color: rgb(8, 201, 114);">Pastry@gmail.com</label>
                            </label>   
                        </div>
                </div>
                </div>
   ...
   <script src="{{ asset('js/vendeur/vendeurPreference.js') }}"></script>
</body>
</html>